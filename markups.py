...
mon1 = InlineKeyboardButton('1 месяц - 30 BYN', callback_data='mon1')
mon3 = InlineKeyboardButton('3 месяца - 75 BYN', callback_data='mon3')
mon6 = InlineKeyboardButton('6 месяцев - 120 BYN', callback_data='mon6')
mon12 = InlineKeyboardButton('12 месяцев - 210 BYN', callback_data='mon12')
